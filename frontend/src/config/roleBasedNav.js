...
export const navigationConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Appointments', path: '/staff/appointments-management', allowedRoles: ['Staff'] },
      { label: 'Part Requests', path: '/staff/part-requests', allowedRoles: ['Staff'] },
      { label: 'Service Reviews', path: '/staff/service-reviews', allowedRoles: ['Staff'] },
