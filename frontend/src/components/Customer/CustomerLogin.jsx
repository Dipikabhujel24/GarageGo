        ...
        <div className="login-form">
          ...
          <div className="social-login">
            ...
            <div className="social-icons">
              <button type="button" className="social-icon-btn google">
                G
              </button>
              <button type="button" className="social-icon-btn facebook">
                f
              </button>
              <button type="button" className="social-icon-btn apple">
                a
              </button>
            </div>
          </div>
          ...
          <div className="register-link-container">
            ...
            <p>
              Staff and admin accounts use this same sign-in form.
            </p>
          </div>
        </div>
      </div>
